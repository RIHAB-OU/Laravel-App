                            ...
                            <div class="card-body p-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        <h2 class="text-center fw-bold mb-4 mt-4">User Registration</h2>
                                        <p class="text-center text-muted mb-4">Join us to enjoy our services and benefits.</p>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-registration/draw1.webp" class="img-fluid" alt="User image">
                                    </div>
                                </div>
                            </div>
                        </div>
