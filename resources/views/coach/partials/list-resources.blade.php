...
<body>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>Resources</h1>
            <a href="{{ route('resources.create') }}" class="btn btn-primary btn-add">
                ...
                <tbody>
                    @foreach($resources as $resource)
                        <tr>
                            ...
                            <td>{{ $resource->type }}</td>
                            <td>
                                <a href="{{ route('resources.edit', $resource->id) }}" class="btn btn-warning btn-action">
                                    <i class="fas fa-edit icon-size"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-action" data-toggle="modal" data-target="#deleteModal{{ $resource->id }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel{{ $resource->id }}">Delete Resource</h5>
